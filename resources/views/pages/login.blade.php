        ...
        <div class="auth-layout">
            ...
            <section class="auth-panel">
                ...
                @else
                    ...
                    <p class="mt-2 text-center text-xs text-slate-500">{{ $googleOauthHint ?? 'Google Sign-In is currently unavailable. Configure Google OAuth in the app environment.' }}</p>
                @endif
