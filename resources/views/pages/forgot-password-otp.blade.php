    ...
    <div class="auth-page-shell">
        <div class="auth-layout">
            <section class="auth-aside">
                ...
                <h2 class="auth-aside-title">Verify OTP.</h2>
            ...
            <section class="auth-panel">
                ...
                <h1 class="mt-7 text-center text-4xl font-black tracking-tight text-slate-900 sm:text-5xl">Verify OTP</h1>
                <p class="mt-3 text-center text-base text-slate-500 sm:text-lg">Enter the code within 10 minutes.</p>
                ...
                <form action="{{ route('password.otp.verify') }}" method="POST" class="mt-8 space-y-5">
                    ...
                    <label class="form-field gap-2.5">
                        ...
                        <div class="auth-input-wrap">
                            ...
                            <input type="email" name="email" class="auth-input" value="{{ old('email', $email ?? '') }}" required>
                        </div>
                    </label>
                    ...
                    <label class="form-field gap-2.5">
                        ...
                        <div class="auth-input-wrap">
                            ...
                            <input type="text" name="otp" inputmode="numeric" pattern="[0-9]{6}" maxlength="6" class="auth-input" placeholder="123456" required>
                        </div>
                    </label>
                ...
                <p class="mt-8 text-center text-base text-slate-500">
                    Need a new code?
                    <a href="{{ route('password.request') }}" class="font-semibold text-brand-700 transition hover:text-brand-800">Send OTP again</a>
                </p>
            </section>
        </div>
    </div>
