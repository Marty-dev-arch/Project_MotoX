                ...
                <div class="flex flex-wrap items-start justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <div class="budget-range-pills">
                            <button type="button" class="budget-range-pill">D</button>
                            <button type="button" class="budget-range-pill">M</button>
                            <button type="button" class="budget-range-pill">Y</button>
                            <button type="button" class="budget-range-pill budget-range-pill-active">All</button>
                            <button type="button" class="budget-range-pill">Custom</button>
                        </div>
