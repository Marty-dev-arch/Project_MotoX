    ...
    <section class="space-y-6">
        ...
        <div class="grid gap-4 md:grid-cols-2 2xl:grid-cols-5">
            <article class="panel-card p-5">
                ...
                <p class="mt-2 text-4xl font-black tracking-tight text-slate-900">{{ number_format($orders->count()) }}</p>
            </article>
            <article class="panel-card p-5">
                <p class="muted-label">Pending</p>
                <p class="mt-2 text-4xl font-black tracking-tight text-slate-900">{{ number_format($statusCounts['pending']) }}</p>
            </article>
            <article class="panel-card p-5">
                <p class="muted-label">In Progress</p>
                <p class="mt-2 text-4xl font-black tracking-tight text-slate-900">{{ number_format($statusCounts['in_progress']) }}</p>
            </article>
            <article class="panel-card p-5">
                <p class="muted-label">Completed</p>
                <p class="mt-2 text-4xl font-black tracking-tight text-slate-900">{{ number_format($statusCounts['completed']) }}</p>
            </article>
            <article class="panel-card p-5">
                <p class="muted-label">Estimated Value</p>
                <p class="mt-2 text-4xl font-black tracking-tight text-slate-900">PHP {{ number_format($totalEstimated, 2) }}</p>
            </article>
        </div>
